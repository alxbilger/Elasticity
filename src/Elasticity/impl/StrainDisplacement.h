...
/**
 * Specialization for a linear tetrahedron
 */
template <class real>
sofa::type::Vec<6, real> strainDisplacementVectorProduct(const sofa::type::Mat<6, 12, real>& B, const sofa::type::Vec<12, real>& v)
{
    ...
    Bv[0] = B(0, 0) * v[0] + /*B(0, 1) * v[1] + B(0, 2) * v[2] +*/ B(0, 3) * v[3] + /*B(0, 4) * v[4] + B(0, 5) * v[5] +*/ B(0, 6) * v[6] + /*B(0, 7) * v[7] + B(0, 8) * v[8] +*/ B(0, 9) * v[9]/* + B(0, 10) * v[10] + B(0, 11) * v[11]*/;
    Bv[1] = /*B(1, 0) * v[0] +*/ B(1, 1) * v[1] + /*B(1, 2) * v[2] + B(1, 3) * v[3] +*/ B(1, 4) * v[4] + /*B(1, 5) * v[5] + B(1, 6) * v[6] +*/ B(1, 7) * v[7] + /*B(1, 8) * v[8] + B(1, 9) * v[9] +*/ B(1, 10) * v[10] /*+ B(1, 11) * v[11]*/;
    Bv[2] = /*B(2, 0) * v[0] + B(2, 1) * v[1] +*/ B(2, 2) * v[2] + /*B(2, 3) * v[3] + B(2, 4) * v[4] +*/ B(2, 5) * v[5] + /*B(2, 6) * v[6] + B(2, 7) * v[7] +*/ B(2, 8) * v[8] + /*B(2, 9) * v[9] + B(2, 10) * v[10] +*/ B(2, 11) * v[11];
    Bv[3] = B(3, 0) * v[0] + B(3, 1) * v[1] /*+ B(3, 2) * v[2]*/ + B(3, 3) * v[3] + B(3, 4) * v[4] /*+ B(3, 5) * v[5]*/ + B(3, 6) * v[6] + B(3, 7) * v[7] /*+ B(3, 8) * v[8]*/ + B(3, 9) * v[9] + B(3, 10) * v[10] /*+ B(3, 11) * v[11]*/;
    Bv[4] = B(4, 0) * v[0] /*+ B(4, 1) * v[1]*/ + B(4, 2) * v[2] + B(4, 3) * v[3]/* + B(4, 4) * v[4]*/ + B(4, 5) * v[5] + B(4, 6) * v[6] /*+ B(4, 7) * v[7]*/ + B(4, 8) * v[8] + B(4, 9) * v[9] /*+ B(4, 10) * v[10]*/ + B(4, 11) * v[11];
    Bv[5] = /*B(5, 0) * v[0] +*/ B(5, 1) * v[1] + B(5, 2) * v[2] /*+ B(5, 3) * v[3]*/ + B(5, 4) * v[4] + B(5, 5) * v[5] /*+ B(5, 6) * v[6]*/ + B(5, 7) * v[7] + B(5, 8) * v[8] /*+ B(5, 9) * v[9]*/ + B(5, 10) * v[10] + B(5, 11) * v[11];
    return Bv;
}
...
sofa::type::Vec<12, real> strainDisplacementTransposedVectorProduct(const sofa::type::Mat<6, 12, real>& B, const sofa::type::Vec<6, real>& v)
{
    ...
    B_Tv[ 0] = B(0, 0) * v[0] /*+ B(1,  0) * v[1]*/ + /*B(2,  0) * v[2] +*/ B(3,  0) * v[3] + B(4,  0) * v[4] /*+ B(5,  0) * v[5]*/;
    B_Tv[ 1] = /*B(0, 1) * v[0] +*/ B(1,  1) * v[1] /*+ B(2,  1) * v[2]*/ + B(3,  1) * v[3] /*+ B(4,  1) * v[4]*/ + B(5,  1) * v[5];
    B_Tv[ 2] = /*B(0, 2) * v[0] +*/ /*B(1,  2) * v[1] +*/ B(2,  2) * v[2] /*+ B(3,  2) * v[3]*/ + B(4,  2) * v[4] + B(5,  2) * v[5];
    B_Tv[ 3] = B(0, 3) * v[0] /*+ B(1,  3) * v[1]*/ /*+ B(2,  3) * v[2]*/ + B(3,  3) * v[3] + B(4,  3) * v[4] /*+ B(5,  3) * v[5]*/;
    B_Tv[ 4] = /*B(0, 4) * v[0] +*/ B(1,  4) * v[1] /*+ B(2,  4) * v[2]*/ + B(3,  4) * v[3] /*+ B(4,  4) * v[4]*/ + B(5,  4) * v[5];
    B_Tv[ 5] = /*B(0, 5) * v[0] +*/ /*B(1,  5) * v[1] +*/ B(2,  5) * v[2] /*+ B(3,  5) * v[3]*/ + B(4,  5) * v[4] + B(5,  5) * v[5];
    B_Tv[ 6] = B(0, 6) * v[0] + /*B(1,  6) * v[1] +*/ /*B(2,  6) * v[2] +*/ B(3,  6) * v[3] + B(4,  6) * v[4] /*+ B(5,  6) * v[5]*/;
    B_Tv[ 7] = /*B(0, 7) * v[0] +*/ B(1,  7) * v[1] + /*B(2,  7) * v[2] +*/ B(3,  7) * v[3] /*+ B(4,  7) * v[4]*/ + B(5,  7) * v[5];
    B_Tv[ 8] = /*B(0, 8) * v[0] +*/ /*B(1,  8) * v[1] +*/ B(2,  8) * v[2] /*+ B(3,  8) * v[3]*/ + B(4,  8) * v[4] + B(5,  8) * v[5];
    B_Tv[ 9] = B(0, 9) * v[0] /*+ B(1,  9) * v[1]*/ /*+ B(2,  9) * v[2]*/ + B(3,  9) * v[3] + B(4,  9) * v[4] /*+ B(5,  9) * v[5]*/;
    B_Tv[10] = /*B(0,10) * v[0] +*/ B(1, 10) * v[1] /*+ B(2, 10) * v[2]*/ + B(3, 10) * v[3] /*+ B(4, 10) * v[4]*/ + B(5, 10) * v[5];
    B_Tv[11] = /*B(0,11) * v[0] +*/ /*B(1, 11) * v[1] +*/ B(2, 11) * v[2] /*+ B(3, 11) * v[3]*/ + B(4, 11) * v[4] + B(5, 11) * v[5];
